...
// NewMongoFilterBuilder creates a new MongoDB-specific filter builder
func NewMongoFilterBuilder() client.FilterBuilder {
	return &mongoFilterBuilder{filter: bson.M{}}
}

// NewMongoUpdateBuilder creates a new MongoDB-specific update builder
func NewMongoUpdateBuilder() client.UpdateBuilder {
