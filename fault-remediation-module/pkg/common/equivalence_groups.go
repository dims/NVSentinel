...
var RemediationEquivalenceGroups = map[string][]protos.RecommenedAction{
	"restart": {
...
func GetRemediationGroupForAction(action protos.RecommenedAction) string {
...
func GetActionsForGroup(group string) []protos.RecommenedAction {
...
func IsActionInGroup(action protos.RecommenedAction, group string) bool {
